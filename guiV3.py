...
if __name__ == "__main__":
    ...
    Button(root, text='Capture', bg='#AEEEEE', font=('arial', 12, 'normal'), command=btnCapture).place(x=50, y=54)
    Button(root, text='Integrate', bg='#AEEEEE', font=('arial', 12, 'normal'), command=btnIntegrate).place(x=180, y=54)
    Button(root, text='Delete', bg='#AEEEEE', font=('arial', 12, 'normal'), command=btnDelete).place(x=310, y=54)


    # preview
    Label(root, text='Preview', bg='#F0F8FF', font=('Times', 14, 'bold')).place(x=20, y=124)
